...
class Post
{
    ...
    const TYPES = [ 'Programacion' => 'Programacion' ,'Opinion' => 
    'Opinion', 'Humor' => 'Humor', 'Aporte' => 'Aporte', 'Debate' => 'Debate'];
    ...
    public function __construct($title = null, $type = null, $descripcion = null, $file = null, $url = null)
    {
        $this->title = $title;
        $this->type = $type;
